...
final class GetNextWeekScheduleAction implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $nextSchedule = $this->schedules->findNextWeekSchedule($person, $schedule);
        if (!$nextSchedule) {
