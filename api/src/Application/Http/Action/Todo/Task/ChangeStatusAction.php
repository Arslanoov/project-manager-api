...
use Domain\Model\Todo\UseCase\Schedule\Task\ChangeStatus\Command;
use Domain\Model\Todo\UseCase\Schedule\Task\ChangeStatus\Handler;
...
final class ChangeStatusAction implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $this->canChangeStatus($userId, $task);
