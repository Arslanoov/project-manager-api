...
use Domain\Model\Todo\UseCase\Schedule\Task\Step\Remove\Command;
use Domain\Model\Todo\UseCase\Schedule\Task\Step\Remove\Handler;
...
final class RemoveAction implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $this->canDeleteStep($userId, $step);
