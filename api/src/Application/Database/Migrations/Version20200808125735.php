...
final class Version20200808125735 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE todo_schedules (id UUID NOT NULL, person_id UUID NOT NULL, ' .
            'date DATE NOT NULL, type VARCHAR(255) NOT NULL, tasksCount INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE todo_schedule_task_steps (id int NOT NULL, task_id UUID NOT NULL, ' .
            'name VARCHAR(255) NOT NULL, sortOrder INT NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN todo_schedule_task_steps.name IS ' .
            '\'(DC2Type:todo_schedule_task_step_name)\'');
        $this->addSql('COMMENT ON COLUMN todo_schedule_task_steps.sortOrder IS ' .
            '\'(DC2Type:todo_schedule_task_step_sort_order)\'');
        $this->addSql('COMMENT ON COLUMN todo_schedule_task_steps.status IS ' .
            '\'(DC2Type:todo_schedule_task_step_status)\'');
        $this->addSql('CREATE TABLE todo_schedule_tasks (id UUID NOT NULL, schedule_id UUID NOT NULL, name ' .
            'VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, level VARCHAR(255) NOT NULL, ' .
        ...
        $this->addSql('COMMENT ON COLUMN todo_schedule_tasks.description IS ' .
            '\'(DC2Type:todo_schedule_task_description)\'');
        $this->addSql('COMMENT ON COLUMN todo_schedule_tasks.level IS ' .
            '\'(DC2Type:todo_schedule_task_important_level)\'');
        $this->addSql('COMMENT ON COLUMN todo_schedule_tasks.status IS \'(DC2Type:todo_schedule_task_status)\'');
        $this->addSql('ALTER TABLE todo_schedules ADD CONSTRAINT FK_7CAE6A9E217BBB47 ' .
            'FOREIGN KEY (person_id) REFERENCES todo_persons (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE todo_schedule_task_steps ADD CONSTRAINT FK_FD20F0C38DB60186 ' .
            'FOREIGN KEY (task_id) REFERENCES todo_schedule_tasks (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE todo_schedule_tasks ADD CONSTRAINT FK_4AF7685CA40BC2D5 ' .
            'FOREIGN KEY (schedule_id) REFERENCES todo_schedules (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
