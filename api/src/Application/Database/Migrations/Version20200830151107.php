...
final class Version20200830151107 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_users ADD sign_up_confirm_token_expires TIMESTAMP(0) WITHOUT TIME' .
            ' ZONE DEFAULT NULL');
        $this->addSql('COMMENT ON COLUMN user_users.status IS \'(DC2Type:user_user_status)\'');
        $this->addSql('COMMENT ON COLUMN user_users.sign_up_confirm_token_expires IS ' .
