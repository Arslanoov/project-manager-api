...
namespace Domain\Model\Todo\Entity\Schedule\Task;
...
class Task
{
    ...
    /**
     * @var Schedule
     * @ORM\ManyToOne(targetEntity="Domain\Model\Todo\Entity\Schedule\Schedule", inversedBy="tasks")
     ...
     * @var Collection
     * @ORM\OneToMany(
     *     targetEntity="Domain\Model\Todo\Entity\Schedule\Task\Step\Step",
     *     mappedBy="task",
     *     cascade={"REMOVE"}
     * )
     */
